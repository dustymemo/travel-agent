...
description: Security engineering toolkit for threat modeling, vulnerability analysis, secure architecture, and penetration testing. Includes STRIDE analysis, OWASP guidance, cryptography patterns, secret scanning, and security scanning tools. Use when the user asks about security architecture, threat modeling, STRIDE analysis, penetration testing, vulnerability assessments, secure coding practices, OWASP, application security, cryptography implementation, secret scanning, security audits, zero trust, attack surface analysis, CVE remediation, or security best practices.
---
